...
part of 'complex_general_information_and_gallery_template_view_model.dart';
...
mixin _$ComplexGeneralInformationAndGalleryTemplateViewModel
    on _ComplexGeneralInformationAndGalleryTemplateViewModelBase, Store {
  late final _$templateTwoAtom = Atom(
      name:
          '_ComplexGeneralInformationAndGalleryTemplateViewModelBase.templateTwo',
      context: context);
  ...
  late final _$_getDetailAsyncAction = AsyncAction(
      '_ComplexGeneralInformationAndGalleryTemplateViewModelBase._getDetail',
      context: context);
