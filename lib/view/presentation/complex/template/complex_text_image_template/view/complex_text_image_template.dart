...
import 'package:goldcity/view/presentation/complex/template/complex_text_image_template/view_model/complex_text_image_template_view_model.dart';
...
class ComplexTextImageTemplate extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseView<ComplexTextImageTemplateViewModel>(
      viewModel: ComplexTextImageTemplateViewModel(),
      onModelReady: (model) {
        model.setContext(context);
      },
      onPageBuilder:
          (BuildContext context, ComplexTextImageTemplateViewModel value) =>
              Scaffold(
        body: SafeArea(
          child: isTablet()
