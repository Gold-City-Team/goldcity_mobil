...
mixin _$GalleryViewModel on _GalleryViewModelBase, Store {
  ...
  late final _$categoryIndexAtom =
      Atom(name: '_GalleryViewModelBase.categoryIndex', context: context);

  @override
  String? get categoryIndex {
    _$categoryIndexAtom.reportRead();
    return super.categoryIndex;
  }

  @override
  set categoryIndex(String? value) {
  ...
  void changeCategory(String value) {
    final _$actionInfo = _$_GalleryViewModelBaseActionController.startAction(
        name: '_GalleryViewModelBase.changeCategory');
    try {
