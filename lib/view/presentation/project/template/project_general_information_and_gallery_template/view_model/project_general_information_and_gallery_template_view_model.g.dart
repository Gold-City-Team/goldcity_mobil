...
part of 'project_general_information_and_gallery_template_view_model.dart';
...
mixin _$ProjectGeneralInformationAndGalleryTemplateViewModel
    on _ProjectGeneralInformationAndGalleryTemplateViewModelBase, Store {
  late final _$templateTwoAtom = Atom(
      name:
          '_ProjectGeneralInformationAndGalleryTemplateViewModelBase.templateTwo',
      context: context);
  ...
  late final _$_getDetailAsyncAction = AsyncAction(
      '_ProjectGeneralInformationAndGalleryTemplateViewModelBase._getDetail',
      context: context);
