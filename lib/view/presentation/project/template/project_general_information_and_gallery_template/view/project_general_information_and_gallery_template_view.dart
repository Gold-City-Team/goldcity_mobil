...
import 'package:goldcity/view/presentation/project/template/project_general_information_and_gallery_template/view_model/project_general_information_and_gallery_template_view_model.dart';
...
class GeneralInformationAndGalleryTemplateView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BaseView<ProjectGeneralInformationAndGalleryTemplateViewModel>(
      viewModel: ProjectGeneralInformationAndGalleryTemplateViewModel(),
      onModelReady: (model) {
