...
part of 'project_feature_template_view_model.dart';
...
mixin _$ProjectFeatureTemplateViewModel
    on _ProjectFeatureTemplateViewModelBase, Store {
  late final _$templateEntityAtom = Atom(
      name: '_ProjectFeatureTemplateViewModelBase.templateEntity',
      context: context);
  ...
  late final _$_getDetailAsyncAction = AsyncAction(
      '_ProjectFeatureTemplateViewModelBase._getDetail',
      context: context);
