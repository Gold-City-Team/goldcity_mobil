...
part of 'project_two_main_image_template_view_model.dart';
...
mixin _$ProjectTwoMainImageTemplateViewModel
    on _ProjectTwoMainImageTemplateViewModelBase, Store {
  late final _$templateTwoAtom = Atom(
      name: '_ProjectTwoMainImageTemplateViewModelBase.templateTwo',
      context: context);
  ...
  late final _$_getDetailAsyncAction = AsyncAction(
      '_ProjectTwoMainImageTemplateViewModelBase._getDetail',
      context: context);
