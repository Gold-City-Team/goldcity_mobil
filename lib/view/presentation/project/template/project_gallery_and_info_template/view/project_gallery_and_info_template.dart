...
import 'package:goldcity/view/presentation/project/template/project_gallery_and_info_template/view_model/project_gallery_and_info_template_view_model.dart';
import 'package:goldcity/view/widget/image/normal_network_image.dart';
import 'package:goldcity/view/widget/text/label_text.dart';

class ProjectGalleryAndInfoTemplate extends StatelessWidget {
  final int projectSettingsId;
  const ProjectGalleryAndInfoTemplate(
      {required this.projectSettingsId, super.key});

  @override
  Widget build(BuildContext context) {
    return BaseView<ProjectGalleryAndInfoTemplateViewModel>(
      viewModel: ProjectGalleryAndInfoTemplateViewModel(),
      onModelReady: (model) {
      ...
      onPageBuilder: (BuildContext context,
              ProjectGalleryAndInfoTemplateViewModel value) =>
          Scaffold(
        body:
  ...
  Widget tabletView(
      BuildContext context, ProjectGalleryAndInfoTemplateViewModel viewModel) {
    return Stack(
      children: [
