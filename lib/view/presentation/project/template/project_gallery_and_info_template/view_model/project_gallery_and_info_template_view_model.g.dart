...
part of 'project_gallery_and_info_template_view_model.dart';
...
mixin _$ProjectGalleryAndInfoTemplateViewModel
    on _ProjectGalleryAndInfoTemplateViewModelBase, Store {
  late final _$templateTwoAtom = Atom(
      name: '_ProjectGalleryAndInfoTemplateViewModelBase.templateTwo',
      context: context);
  ...
  late final _$_getDetailAsyncAction = AsyncAction(
      '_ProjectGalleryAndInfoTemplateViewModelBase._getDetail',
      context: context);
